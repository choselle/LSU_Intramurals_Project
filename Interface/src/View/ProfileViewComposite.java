...
public class ProfileViewComposite extends Composite {
	...
	public ProfileViewComposite(Composite parent, int style) {
		super(parent, style);
		setBackground(SWTResourceManager.getColor(121, 8, 196));
		setBounds(10, 1072, 1920, 1080);

		Label lblProfilePic = new Label(this, SWT.NONE);
		lblProfilePic.setImage(SWTResourceManager.getImage(ProfileViewComposite.class, "/images/lsu-mike-the-tiger.jpg"));
		...
		lblNewLabel_1.setForeground(SWTResourceManager.getColor(255, 215, 0));
		...
		lblLogo.setBackground(SWTResourceManager.getColor(121, 8, 196));
		...
		lblHeader.setBackground(SWTResourceManager.getColor(121, 8, 196));
		lblHeader.setForeground(SWTResourceManager.getColor(255, 215, 0));
		...
		lblNextMatch.setBackground(SWTResourceManager.getColor(121, 8, 196));
		lblNextMatch.setForeground(SWTResourceManager.getColor(255, 215, 0));
		...
		lblNewsHeader.setBackground(SWTResourceManager.getColor(121, 8, 196));
		lblNewsHeader.setFont(SWTResourceManager.getFont("Moire ExtraBold", 42, SWT.BOLD));
		lblNewsHeader.setForeground(SWTResourceManager.getColor(255, 215, 0));
	...
	public static void PostProfilePressed() {
		if (!(ppc != null)) {
			...
			ppc.setBounds(10, 1072, 1884, 1039);
		}
		else {
			ppc.setVisible(true);
		}
	...
	public static void PostTeamPressed() {
		if (!(ptc != null)) {
			...
			ptc.setBounds(10, 1072, 1884, 1039);
		}
		else {
			ptc.setVisible(true);
		}
